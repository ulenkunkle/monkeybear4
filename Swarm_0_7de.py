...
pygame.init()
#pygame.mixer.init()
pygame.mixer.music.load("ping11.wav")
sounda= pygame.mixer.Sound("ping11.wav")
soundb = pygame.mixer.Sound("ping9.wav")
soundc = pygame.mixer.Sound("ping12.wav")
soundd = pygame.mixer.Sound("ping14.wav")
sounde = pygame.mixer.Sound("ping15.wav")
soundf = pygame.mixer.Sound("ping16.wav")
sounda.play()
